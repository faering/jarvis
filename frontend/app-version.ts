...
// the script itself. It is the app's own version (`version.sh app`), in the same format
// as the agent's GET /version but not the same value: the components release
// independently (ADR 0004). Runs in Node (vite.config.ts), never in the browser bundle.
