...
- Pending: the client itself (#30) isn't merged yet. Until it is, `.claude/rules/tauri.md`
  and the `AGENT <-> RUST` edge in `docs/architecture.md` still describe Rust as the bridge;
  the #30 PR corrects both.
